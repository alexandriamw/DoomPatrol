// function player(isComputer, name, user) {
//     this.isComputer = isComputer;
//     this.name = name;
//     this.user = user;
// }
// player.prototype.attack = function() {
//     let uhigh = this.user.highest_attack
//     let ulow = this.user.lowest_attack
//     return Math.round(Math.random().toFixed(1)*uhigh)
// }

// let user = new player("User", "Arhum", pokeChoice.Charizard);
// if(pokeChoice.hasOwnProperty(user.user.name)) {
//     delete pokeChoice[user.user.name];
// }

// let compFighter = function() {
//     let pokeKeys = Object.keys(pokeChoice);
//     let pokeAmt = pokeKeys.length;
//     return pokeChoice[pokeKeys[Math.round(Math.random() * (pokeAmt-1))]]
// }
// let comp = new player("Computer","Red", comp_choice());
